...
\addcontentsline{toc}{chapter}{DVD containing all project code}
...
\bibitem{pipic} readwrite.com /, \emph{Raspberry Pi Model B board layout without a protective case}, (2014), available at
\url{http://readwrite.com/2014/01/20/raspberry-pi-everything-you-need-to-know#awesm=~oBwfeWDLWC0rMX}.

\bibitem{picampi} adafruit.com /, \emph{Raspberry Pi Camera Module}, (2014), available at
\url{http://www.adafruit.com/products/1367}.

\bibitem{picampiboard} embeddedcomputer.nl /, \emph{Camera Module attached to the Raspberry board with no casing}, (2014), available at
