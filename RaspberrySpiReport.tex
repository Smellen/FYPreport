...
This project will implement the most popular features such as motion detection, live streaming and media storage that are all implemented in an affordable system that can be set up in a home by a user allowing them full control over the system which allows for customization of features or adding on additional features. \\
\end{abstract}
