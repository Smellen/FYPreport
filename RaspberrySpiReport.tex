...
\label {sec:motion}
% LiveStreaming
Explain the motion detection <Example motion detection photos>
\section {Video Live Streaming}
\label {sec:video}
% Future Possibilites
Motion. How motion works. <Image to show how live streaming works>
\section {Future Possibilities}
\label {sec:future}
Endless future possibilities. Audio/better livestreaming/setting up times to take photos/ automate site.
\chapter {Testing}
\label {ch:test}
%
%
